Shader "Custom/SpatialMapping/Wireframe"
{
    Properties
    {
        _WireThickness ("Wire Thickness", RANGE(0, 800)) = 100
        _WireFrontColour ("Wire Front Color", Color) = (1,1,1,1)
        _WireBackColour ("Wire Back Color", Color) = (.75,.75,.75,1)
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 _WireFrontColour;
            half4 _WireBackColour;
            ...
            half4 frag(g2f i, bool isFrontFace : SV_IsFrontFace) : SV_Target
            {
                ...
                half4 wireColor = colors[0];

                

                half4 finalColor = lerp(wireColor, float4(0,0,0,0), t);
                //finalColor = Remap(finalColor,float2 (0,1),float2(1,0));
                clip(.5 - finalColor);

                float4 _wireColor = isFrontFace ? _WireFrontColour : _WireBackColour;
                return _wireColor;
            }
            ENDHLSL
        }
